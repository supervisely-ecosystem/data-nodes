...
| [Orientation](https://github.com/supervisely-ecosystem/data-nodes/blob/master/src/ui/dtl/actions/spatial_level_transforms/orientation/README.md#orientation)                                                                 | Rotates portrait or landscape images to the target orientation with a selectable 90-degree direction.     | +      | -      |
...
| [Mask Morphology](https://github.com/supervisely-ecosystem/data-nodes/blob/master/src/ui/dtl//actions/annotation_transforms/mask_morphology/README.md#mask-morphology)                                                       | Applies morphology operations to smooth, clean, shrink, or expand bitmap masks before further processing.  | +      | -      |
...
| [Deploy YOLO (v8 - v26)](https://github.com/supervisely-ecosystem/data-nodes/blob/master/src/ui/dtl/actions/neural_networks/deploy/yolo.md)                                                                                 | Deploys the latest YOLO models with comprehensive support for all model variants and tasks.                | +      | -      |
