...
`Deploy YOLO v8 - v26` using [Serve YOLO v8 - v26](../../../../supervisely-ecosystem/yolo/supervisely_integration/serve) app to serve models and can be used to deploy custom and pretrained models that you can use via `Apply NN` layer. Custom models will appear in the custom tab of the table only if you have any trained YOLO v8 - v26 models in your Team Files. You can train your own model using [Train YOLO v8 - v26](https://ecosystem.supervisely.com/apps/yolo/supervisely_integration/train) app. If you want to use pretrained models, simply select "Pretrained public models" tab in model selector.
...
1. Add `Deploy YOLO v8 - v26` layer
